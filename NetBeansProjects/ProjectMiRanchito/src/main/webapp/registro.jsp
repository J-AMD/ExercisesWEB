...
<body>
    ...
    <form action="ServletRegistrarUsuario" method="POST" style="padding-top: 100px">
			<div class="container">
				...
				<div class="row d-flex justify-content-center">
					...
					<div class="row d-flex justify-content-center">
					<div class="col-5">
						<input class="form-control centrar" type="text" name="usuario" placeholder="Usuario">
						<input class="form-control centrar" type="password" name="contrasenia" placeholder="Contraseña">
					</div>
				</div>
			</div>
			<div class="row">
